class CorpoCeleste:
    ...
    # def __str__(self):
    #     risultato = ""
    #     print(f"Corpi celesti adiacenti al nodo {self.nome}:")
    #      for s in self.adiacenti:
    #         lista = [s.nome, s.distanza]
    #         risultato = ', '.join(f"{s.nome}:{s.distanza}" for nome,distanza in lista)
    #         print(risultato)
        #     print(f"Nome: {s.nome} distanza:{s.distanza}")
...
class MappaStellare:
    ...
    # def rimuovi_corpo_celeste(self, corpo_celeste):
    #     for adiacente in corpo_celeste.adiacenti:
    #         # corpo_celeste.rimuovi_collegamento(adiacente.nome, adiacente.distanza)
    #         corpo_celeste.rimuovi_collegamento(adiacente[0], adiacente[1])
    #         # corpo_celeste.rimuovi_collegamento(corpo_celeste.nome, corpo_celeste.adiacenti.distanza)
    ...
    def aggiungi_percorso(self,partenza,arrivo,distanza):
        if partenza in self.corpi_celesti and arrivo in self.corpi_celesti:
            self.corpi_celesti[partenza].aggiungi_collegamento(arrivo, distanza)
    ...
    # def __str__(self):
    #     for stella in self.corpi_celesti:
    #         risultato = ""
    #         #print(f"Il corpo celeste:{stella.nome} è vicino ai corpi celesti: ")
    #         lista = [stella.nome, stella.distanza, stella.adiacenti]
    #         #risultato = ', '.join(str(s.distanza) for x in lista)
    #         risultato = "; ".join(stella.__str__() for nome, distanza in lista)
    #         print(risultato)
...
pianeta10.aggiungi_collegamento("Eris", 222)
