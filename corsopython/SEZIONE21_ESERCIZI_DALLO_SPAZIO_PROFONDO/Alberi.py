...
class Sistema(ComponentAstronave):
    ...
    def aggiungi(self, Component):
        pass  # Un sistema non ha figli, quindi non aggiunge nulla

    def rimuovi(self, Component):
        pass  # Un sistema non ha figli, quindi non rimuove nulla

    def ottieniFiglio(self, i: int):
        return None  # Un sistema non ha figli, quindi restituisce None
...
modulo_difesa=ModuloComplesso("Modulo difesa")
scudo = Sistema("Scudo 1")
scudo2 = Sistema("Scudo 2")
scudo3 = Sistema("Svudo 3")
...
cabine_equipaggio=ModuloComplesso("Cabine equipaggio")
cabina1=Sistema("Cabina 1")
cabina2=Sistema("Cabina 2")
cabina3=Sistema("Cabona 3")
...
esperimento3=Sistema("Esperiemnto 3 sulle radiazioni cosmiche")
...
e11=Sistema("Esperimento 11")
e12=Sistema("Esperimento 12")
e13=Sistema("Esperimento 13")
...
esperimenti.aggiungi(e12)
esperimenti.aggiungi(e13)
