...
class SistemaDiAllarme(Subject):
    ...
    def attiva_allarme(self):
       #attiva il sistema di attiva_allarme
    ...
    def disattiva_allarme(self):
        ...
        #disattiva il sistema di attiva_allarme
...
class PonteComando(Observer):
    ...
    def aggiorna(self,status):
        if(status):
            print("Ponte di Comando: Bloccando tutte le entrate e le uscite")
        else:
